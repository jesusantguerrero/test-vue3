var Vue = (function (exports) {
  ...
  function formatTraceEntry({ vnode, recurseCount }, depth = 0) {
      ...
      const close = `>` + postfix;
      const rootLabel = vnode.component.parent == null
          ? `(Root)`
          : ``;
      return vnode.props
  ...
  function openBlock(disableTrackng) {
  ...
  */
  ...
  function createDevEffectOptions(instance) {
      return {
          ...
          onTrack: instance.rtc
              ? e => invokeHooks(instance.rtc, e)
              : void 0,
          onTrigger: instance.rtg
              ? e => invokeHooks(instance.rtg, e)
              : void 0
      };
  }
      ...
      for (let i = 0; i < children.length; i++) {
          ...
          if (child.type === 1 /* ELEMENT */ &&
              ...
              if (isStaticNode(child, resultCache)) {
                  ...
                  if (!flag || flag === PublicPatchFlags.NEED_PATCH) {
  ...
  const transformIf = createStructuralDirectiveTransform(/^(if|else|else-if)$/, (node, dir, context) => {
      if (dir.name !== 'else' &&
          ...
          context.onError(createCompilerError(35 /* X_IF_NO_EXPRESSION */, loc));
  ...
  function buildProps(props, elementLoc, context, isComponent = false) {
      ...
      const anaylizePatchFlag = ({ key, value }) => {
